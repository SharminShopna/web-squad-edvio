      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {messages.length === 0 ? (
            ...
            >
              <h2 className="text-2xl font-bold my-15">How can I help you today?</h2>
            ...
            messages.map((msg, idx) => (
              ...
              >
                <div
                  className={`max-w-[80%] rounded-2xl p-5 ${msg.from === "user"
                      ? "border"
                      : " border"
                    }`}
                  style={{
