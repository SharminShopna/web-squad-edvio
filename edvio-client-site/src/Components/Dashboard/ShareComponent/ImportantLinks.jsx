    ...
    <div className="rounded-lg bg-neutral my-10">
        ...
        isExist || <div className='h-[1px] bg-base-content opacity-[0.1] mt-5'></div>
          ...
          <div className="p-6">
            ...
            <div>
              <h3 className="text-xl font-medium text-TealGreen">CV link (Google Drive)</h3>
              <p className="mt-2">N/A</p>
            </div>
            <div>
              <h3 className="text-xl font-medium text-TealGreen">Github Profile</h3>
              <p className="mt-2">N/A</p>
            </div>
           </div>
           <div className="grid grid-cols-1 lg:grid-cols-2 mt-10">
            <div>
              <h3 className="text-xl font-medium text-TealGreen">Portfolio link</h3>
              <p className="mt-2">N/A</p>
            </div>
            <div>
              <h3 className="text-xl font-medium text-TealGreen">LinkedIn Profile link</h3>
              <p className="mt-2">N/A</p>
            </div>
           </div>
