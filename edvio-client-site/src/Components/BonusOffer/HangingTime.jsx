...
export default function HangingTime() {
  ...
  return (
    ...
    <h2 className="text-lg md:text-xl font-bold text-gray-800">⏳ Limited Offer Ends In:</h2>
    <div className="mt-4 grid grid-cols-4 gap-3 text-center">
      {[
        ...
        <div key={index} className="bg-gradient-to-b from-yellow-500 to-purple-500 text-white w-14 h-14 flex flex-col items-center justify-center rounded-lg text-sm md:text-base font-semibold shadow-lg">
          {item.value}
